...
import { Copy, Download, Clipboard, Search } from "lucide-react";
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-8 text-center">
          <div className="space-y-2">
            <div className="mb-2 inline-block rounded-lg bg-purple-100 px-3 py-1 text-sm text-purple-700 dark:bg-purple-900 dark:text-purple-50">
              {t("badge")}
            </div>
          ...
          <div className="relative mx-auto mt-12 hidden w-full max-w-5xl md:block">
            <div className="grid grid-cols-4 gap-4">
              <div className="relative flex flex-col items-center space-y-4">
                <div className="z-10 flex h-16 w-16 items-center justify-center rounded-full bg-purple-600 text-xl font-bold text-white shadow-lg">
                  1
                </div>
              ...
              <div className="relative flex flex-col items-center space-y-4">
                ...
                <div className="h-full rounded-xl border border-gray-100 bg-white p-6 shadow-md transition-all duration-200 hover:-translate-y-1 hover:shadow-md dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <p className="text-muted-foreground">
                    {t("steps.search.descriptionDesktop")}
                  </p>
                </div>
              </div>
          ...
          <div className="relative mx-auto w-full max-w-sm space-y-8 md:hidden">
            ...
            <div className="absolute top-0 bottom-16 left-4 w-0.5 bg-purple-200"></div>

            <div className="relative flex items-start space-x-6">
              <div className="z-10 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-purple-600 font-bold text-white">
                1
              </div>
            ...
            <div className="relative flex items-start space-x-6">
              ...
              <div className="flex-1 rounded-lg border border-gray-100 bg-white p-4 shadow-md transition-all duration-200 hover:-translate-y-1 hover:shadow-md dark:border-gray-700 dark:bg-gray-800">
                ...
                <p className="text-muted-foreground text-sm">
                  {t("steps.search.descriptionMobile")}
                </p>
              </div>
            </div>
